const ARCHIVE_MANIFEST = "./archive/pugilism.json";
const DEMO_MANIFEST = "./demo/pugilism.json";
...
async function loadManifest() {
  ...
  throw new Error("No PUGILISM manifest found.");
}
...
async function init() {
  try {
    ...
    console.error(error);
    status.textContent = "PUGILISM ARCHIVE COULD NOT BE LOADED.";
  }
}
